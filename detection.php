...
<html>
<head>
    <title>Detection Detailed Report</title>
    <style>
        div{
...
<body>
    ...
    <div class="item_right">
            ...
            $result=$conn->query("SELECT * FROM traffic_records ORDER BY id DESC LIMIT 7;");
            ...
            while ($row = $result->fetch_array())
            {
                ...
                echo "<td class=\"report\">".$row['cips']."</td>";
                echo "<td class=\"report\">".$row['sips']."</td>";
                echo "<td class=\"report\">".$row['bips']."</td>";
            }
            echo "</table>";
            $conn -> close();
            ?>
